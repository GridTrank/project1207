...
function initHeader() {
	var toggle = document.documentElement.clientWidth >= 960 ? 'data-bs-toggle="dropdown"' : '';
	let labelHtml = ''
	for (var i = 0; i < headLabelList.length; i++) {
		labelHtml += `<div class= "dropdown_wrap" data-index=${i}>
	                            <div ${toggle} class="label_item"> ${headLabelList[i].label}</div>
	                            <div class="${document.documentElement.clientWidth >= 960 ? 'dropdown-menu' :'dropdown-mobile'}" >
